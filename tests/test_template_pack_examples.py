...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("essay-opinion.point-coverage.json", "BLOCK", "TMP_EO_POINT_COVERAGE", 1),
        ("summarize-written-text.point-coverage.json", "BLOCK", "TMP_SWT_POINT_COVERAGE", 1),
        ("summarize-spoken-text.point-coverage.json", "BLOCK", "TMP_SST_POINT_COVERAGE", 1),
        ("oral-interview-qa.point-coverage.json", "BLOCK", "TMP_OIQ_POINT_COVERAGE", 1),
        ("cue-card-long-turn.point-coverage.json", "BLOCK", "TMP_CLT_POINT_COVERAGE", 1),
        ("collaborative-discussion.point-coverage.json", "BLOCK", "TMP_CD_POINT_COVERAGE", 1),
        ("essay-discussion.point-coverage.json", "BLOCK", "TMP_ED_POINT_COVERAGE", 1),
        ("report-visual-data.observation-coverage.json", "BLOCK", "TMP_RVD_OBSERVATION_COVERAGE", 1),
        ("read-aloud.reference-mismatch.json", "BLOCK", "TMP_RA_REFERENCE_MISMATCH", 1),
        ("describe-picture.detail-coverage.json", "BLOCK", "TMP_DP_DETAIL_COVERAGE", 1),
        ("repeat-sentence.reference-mismatch.json", "BLOCK", "TMP_RS_REFERENCE_MISMATCH", 1),
        ("retell-lecture.point-coverage.json", "BLOCK", "TMP_RL_POINT_COVERAGE", 1),
        ("answer-short-question.point-coverage.json", "BLOCK", "TMP_ASQ_POINT_COVERAGE", 1),
        ("respond-to-information.point-coverage.json", "BLOCK", "TMP_RTI_POINT_COVERAGE", 1),
        ("respond-to-written-request.point-coverage.json", "BLOCK", "TMP_RTWR_POINT_COVERAGE", 1),
        ("write-sentence-from-picture.keyword-missing.json", "BLOCK", "TMP_WSFP_KEYWORD_MISSING", 1),
        ("integrated-writing.claim-coverage.json", "BLOCK", "TMP_IW_CLAIM_COVERAGE", 1),
        ...
        ("yes-no-not-given.label-evidence-mismatch.json", "BLOCK", "TMP_YNNG_LABEL_EVIDENCE_MISMATCH", 1),
