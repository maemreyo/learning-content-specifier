...
scripts:
  sh: scripts/bash/check-workflow-prereqs.sh --json --paths-only --skip-branch-check
  ps: scripts/powershell/check-workflow-prereqs.ps1 -Json -PathsOnly -SkipBranchCheck
---
