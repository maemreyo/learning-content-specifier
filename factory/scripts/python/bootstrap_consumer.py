...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--consumer-owner", default=os.getenv("LCS_CONSUMER_REPO_OWNER", "github"))
    parser.add_argument("--consumer-repo", default=os.getenv("LCS_CONSUMER_REPO_NAME", "lcs-output-consumer"))
    parser.add_argument("--core-owner", default=os.getenv("LCS_CORE_REPO_OWNER", "github"))
